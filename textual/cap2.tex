...
\begin{figure}[!ht]
  ...
  \begin{center}
      \includegraphics[scale=0.45]{img/pid_autotuning_relay_astrom_p239}
  \end{center}
  \fonte{Adaptado de \citeonline{Astrom1995}.} 
...
\section{Estado da Arte - Controle Inteligente}

O estado da arte dentro de controle, nasce com a criação de controladores inteligentes. Controle inteligente implementa conceitos de inteligência de organismos biológicos em forma de algoritmos. Esses algoritmos são usados para automatizar os processos de sintonia e promover a adaptação do controle perante as mudanças que a planta possa apresentar. As duas formas principais formas de controle inteligente utilizadas na atualidade são a por \textit{algoritmos genéticos} e \textit{por redes neurais}, que serão explicadas na sequência.
