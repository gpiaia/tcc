...
Na imagem anterior, existe o GMV (General Minimum Variance - Variância Mínima Geral) que é usado para extrair os parâmetros $K$, $T_i$ e $T_d$ do modelo da rede neural linearizada \citeonline{Chen2004}.
