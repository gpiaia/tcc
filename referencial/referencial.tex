...
\begin{figure}[H]
  ...
  \begin{center}
      \includegraphics[scale=0.5]{referencial/img/euler_snider_p28}
  \end{center}
  \fonte{Adaptado de \citeonline{Snider}.} 
...
\begin{figure}[H]
  ...
  \begin{center}
      \includegraphics[scale=0.55]{referencial/img/pi_twomotors_astrom_p308}
  \end{center}
  \fonte{Adaptado de \citeonline{Astrom1995}.} 
...
\begin{figure}[H]
  ...
  \begin{center}
      \includegraphics[scale=0.65]{referencial/img/componentes_linux_p13}
  \end{center}
  \fonte{Adaptado de \citeonline{Tobergte2013}} 
...
\begin{figure}[H]
  ...
  \begin{center}
      \includegraphics[scale=0.55]{referencial/img/kernel_user_space}
  \end{center}
  \fonte{Adaptado de \citeonline{Tobergte2013}} 
...
\begin{figure}[H]
  ...
  \begin{center}
      \includegraphics[scale=0.45]{referencial/img/escalonador_hallinan_p469}
  \end{center}
  \fonte{Adaptado de \citeonline{Tobergte2013}} 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Controle usando Algoritmo Genético}  %control hand p1017
...
\begin{figure}[H]
  ...
  \begin{center}
      \includegraphics[scale=0.65]{referencial/img/pid_genetic_unal_p45}
  \end{center}
  \fonte{Adaptado de \citeonline{Unal2013}.} 
  \label{fig:pid_genetic_unal_p45}
\end{figure}

%conlusão sobre a imagem

Os principais parâmetros de entrada para um AG, são:

\begin{equation}
  \sum , G, \rho, f, \mu, I, S, G_{pp},\Omega, R, \tau  
 \end{equation} 

Onde $\sum$ é o espaço de busca (fenótipo), G é o espaço genético (genótipo), $\rho$ é a função do código genético, $f$ é a função da aptidão, $\mu$ é o tamanho da população, $I$ é a função de inicialização, S é o tipo de seleção, $G_{pp}$ é o percentual da população que sobrevive até a próxima geração, $\Omega$ é o operador genético (crossover ou mutação),  $R$ é a forma de mutação, e por fim, $\tau$, que é o critério de parada \cite{Unal2013}. %posso escrever um conclusão sobre os parâmetros
